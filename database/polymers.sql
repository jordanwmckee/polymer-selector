...
CREATE TABLE `solubility parameters solvents` (
  ...
  `CAS registry num` text DEFAULT NULL,
  `solubility param (MPa1/2)` double DEFAULT NULL,
  `solubility param ((cal/cm3)1/2)` double DEFAULT NULL,
...
INSERT INTO `solubility parameters solvents` (`solvent`, `CAS registry num`, `solubility param (MPa1/2)`, `solubility param ((cal/cm3)1/2)`, `H-bonding group`) VALUES
